...
static const char *stop[]  = { "mpc", "-p", "6600", "-h", "127.0.0.1", "stop", NULL };
static const char *prev[]  = { "mpc", "-p", "6600", "-h", "127.0.0.1", "prev", NULL };
static const char *play[]  = { "mpc", "-p", "6600", "-h", "127.0.0.1", "toggle", NULL };
static const char *next[]  = { "mpc", "-p", "6600", "-h", "127.0.0.1", "next", NULL };
static const char *calcurse[]  = { "qbittorrent", NULL };
